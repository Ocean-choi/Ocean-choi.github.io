...
const translations = {
  en: {
    ...
    'hero-desc':        'Sesese is a Korean children\'s hand-clapping game.<br/>It only begins when two pairs of hands meet.<br/><br/>Sé in Italian means the self.<br/>Not one, but many. Each distinct, each their own.<br/>Different voices, different hands.<br/>Together, something larger becomes possible.<br/><br/>I\'m a visual director working across spatial design, fashion, and branding.<br/>Based in Milan, reaching without borders.<br/>sèsèsè.lab is my way of being.',
    'section-about':    'About',
  ...
  ko: {
    ...
    'hero-desc':        '쎄쎄쎄는 한국의 손뼉 놀이다.<br/>손을 내밀지 않으면 시작되지 않는다.<br/><br/>이탈리아어로 sé는 자기 자신을 뜻한다.<br/>하나가 아닌 여럿. 각자이면서, 각자의 것.<br/>서로 다른 목소리, 서로 다른 손.<br/>함께일 때, 혼자서는 만들 수 없는 것이 생긴다.<br/><br/>나는 공간 디자인, 패션, 브랜딩을 다루는 비주얼 디렉터다.<br/>밀라노를 기반으로, 경계 없이 움직인다.<br/>쎄쎄쎄랩은 나의 태도다.',
    'section-about':    '소개',
    'about-name':       '최세종',
